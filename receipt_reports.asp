...
<body>
    ...
    <main class="receipt">
        <!--
        <p>
            <a href="a_cashier_order_page.asp">
            ...
            <div class="receipt__header">
                ...
                <div class="receipt__header--infos">
                    ...
                    <%
                        ...
                        checkSalesPath = salesPath
                        checkSalesOrderPath = salesOrderPath

                        Dim fs
                        Set fs = Server.CreateObject("Scripting.FileSystemObject")

                        if fs.FolderExists(folderPath) <> false and isInvoiceNumeric = true and transactDate <> "" and invoice <> "" then 

                            do until fs.FileExists(checkSalesPath) = true

                            checkInvoice = "SELECT invoice_no FROM "&checkSalesPath&" WHERE duplicate!='yes' and invoice_no="&invoice
                            set objAccess = cnroot.execute(checkInvoice)
                                    ...
                                    checkSalesPath = recentFolderPath & salesFile
                                    checkSalesOrderPath = recentFolderPath & salesOrderFile

                                else

                                    salesPath = checkSalesPath
                                    salesOrderPath = checkSalesOrderPath
                                    isInvoiceExist = true
                                    EXIT DO
