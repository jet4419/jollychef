...
<div id="main">
    ...
    <div id="content">
        ...
        <div class="container">
            ...
            <h1 class="h2 text-center pb-2 mt-4 main-heading" style="font-weight: 400">Collections Report <p class="report-type">per Date</p></h1>
                            ...
                            if dateCont = "" or dateCont = CDATE(rs("date")) then
                                ...
                                if isCustomerChanged = true then%>
                                    ...
                                    <tr>
                                        ...
                                        <%end if%>
                                        <td><%=dateFormat%></td>
                                        <td><span class="currency-sign">&#8369;</span> <%=formatNumber(customerTotalAmount)%></td>
                                        <td><span class="currency-sign">&#8369;</span> <%=formatNumber(customerTotalCash)%></td>
                                        <td><span class="currency-sign">&#8369;</span> <%=formatNumber(customerTotalCharge)%></td>
                                    </tr>
