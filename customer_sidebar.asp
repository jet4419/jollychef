<div id="mySidebar" class="sidebar">
    <!--<a href="bootProducts.asp" class="main-menus--items"><i class="fab fa-product-hunt sidebar-icons"></i> <span class="icon-text">Products</span></a>-->
    <a href="customer_ordering_page.asp" class="main-menus--items"><i class="fas fa-dollar-sign sidebar-icons dollar-sign"></i> <span class="icon-text">Order</span></a>
    ...
    <a href="cust_order_history.asp" class="main-menus--items"><i class="fas fa-history sidebar-icons"></i> <span class="icon-text">Edited Orders</span></a>
</div>
