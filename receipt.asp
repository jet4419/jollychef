...
<body>
    ...
    <main class="receipt">
        <p>
            <a href="cashier_order_page.asp">
                <i class="fas fa-times exit-icon"></i>
            </a>
        </p>
        <div class="receipt--container">
            <div class="receipt__header">
                <h1 class="receipt__header--text">Sales Receipt</h1>
                <div class="receipt__header--infos">
                    ...
                    <%
                        ...
                        ' Response.Write "Sales Path: " &salesPath & "<br>"
                        ' Response.Write "SalesOrder Path: " &salesOrderPath & "<br>"
                        'Response.Write salesPath

                        Dim fs
                        Set fs = Server.CreateObject("Scripting.FileSystemObject")

                        if (fs.FolderExists(folderPath) <> false or fs.FileExists(salesPath)) and isInvoiceNumeric = true and transactDate <> "" and invoice <> "" then 

                            sqlGetCashPaid = "SELECT ref_no, cash_paid FROM "&salesPath&" WHERE invoice_no="&invoice
                            ...
                            rs.Open "SELECT prod_qty, prod_gen, prod_price, prodamount, date FROM "&salesOrderPath&" WHERE invoice_no="&invoice, CN2
