...
%>    
    ...
    <div class="form-group"> 
        ...
        -->
        <select id="ref_no" class="form-control mr-2" name="ref_no" style="width:650px; "class="chzn-select" required placeholder="Select Reference No.">
        ...
        <%
            ...
            if not rs.EOF then
                ...
                'invoice = CLng(rs("invoice"))
                'debit = CDbl(rs("debit").value)
