...
<!--#include file="cashier_sidebar.asp"-->
    ...
    <%
        ...
        'Response.Write ref_no_and_date(0) & "<br>"
        ...
        Response.Write collectionsPath & "<br>"
    ...
    <div id="content">
        <div class="container mb-5">
            ...
            <% 'rs.Open "SELECT date, ref_no, invoice, debit FROM transactions WHERE ref_no="&ref_no&" and t_type='Pay' and cust_id="&custID, CN2
                ...
                '         "INNER JOIN "&arPath&" ON Transactions.invoice = Accounts_Receivables.invoice_no "&_
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group input-group-sm py-1">
                                ...
                                <input onblur="findTotal()" type="number" id="<%=invoice%>" name="sub_adjustment_total" step="any" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" min="0.1" max="<%=(rs("receivable"))%>">
                            </div>
                        </td>
