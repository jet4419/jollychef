...
<!--#include file="cashier_sidebar.asp"-->
    ...
    <%
        if Request.QueryString("collectID") = "" or Request.QueryString("custID") = "" or Request.QueryString("ref_no") = "" or Request.QueryString("ar_invoice") = "" then Response.Redirect("canteen_homepage.asp")
