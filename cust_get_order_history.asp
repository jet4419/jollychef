            ...
            With oJSON.data
                ...
                for i = 0 To monthsDiff 
                    ...
                    Do 
                        ...
                        getOrders = "SELECT invoice_no, unique_num, cust_name, prod_name, price, upd_price, qty, upd_qty, amount, upd_amount, status, is_added, date FROM "&ordersHolderPath&" WHERE (is_edited='true' OR is_added='true') AND cust_id="&custID&" AND date BETWEEN CTOD('"&queryDate1&"') and CTOD('"&queryDate2&"') ORDER BY unique_num"
