            ...
            <div class="receipt__header">
                ...
                <div class="receipt__header--infos">
                    ...
                    <%
                        ...
                        Dim collectionsPath, transactionsPath, obPath
                        ...
                        ' rs.open "SELECT Collections.ref_no, Collections.invoice, Collections.cash, Accounts_Receivables.balance, Collections.date "&_
                        '         "FROM "&collectionsPath&" "&_
                        '         "INNER JOIN "&arPath&" ON Collections.ref_no = Accounts_Receivables.ref_no "&_
                        '         "WHERE Collections.ref_no = '"&refNo&"' GROUP BY Accounts_Receivables.invoice_no", CN2

                        ' rs.open "SELECT Collections.ref_no, Collections.invoice, Collections.cash, Accounts_Receivables.balance, Collections.date "&_
                        '         "FROM "&collectionsPath&" "&_
                        '         "INNER JOIN "&arPath&" ON Collections.ref_no = Accounts_Receivables.ref_no "&_
                        '         "WHERE Accounts_Receivables.ref_no = '"&refNo&"' GROUP BY Collections.invoice_no", CN2        
